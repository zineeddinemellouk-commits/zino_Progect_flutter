...
class _DepartmentDashboardState extends State<DepartmentDashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // FIXED: Replaced hardcoded background color with theme color
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      // FIXED: Replaced hardcoded color with theme color
          ...
          children: [
            Expanded(
              child: _buildActionCard(
                ...
                // FIXED: Using theme color for student action
                color: _featureColorStudent,
                label: 'Add Student',
            ...
            Expanded(
              child: _buildActionCard(
                ...
                // FIXED: Using feature color for teacher action
                color: _featureColorTeacher,
                label: 'Add Teacher',
                onTap: () => Navigator.push(
                  context,
            ...
            Expanded(
              child: _buildActionCard(
                ...
                // FIXED: Using feature color for subject action
                color: _featureColorSubject,
                label: 'Add Subject',
                onTap: () => Navigator.push(
                  context,
          ...
          children: [
            Expanded(
              child: _buildActionCard(
                ...
                // FIXED: Using feature color for exclusion action
                color: _featureColorExclude,
                label: 'View Exclude',
                onTap: () => Navigator.push(
                  context,

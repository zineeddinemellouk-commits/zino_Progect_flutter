...
function registerFirestore(variant, useFetchStreams = true) {
    commonE4edcbc6_node.setSDKVersion(app.SDK_VERSION);
    app._registerComponent(new component.Component('firestore', (container, { instanceIdentifier: databaseId, options: settings }) => {
        ...
        const firestoreInstance = new commonE4edcbc6_node.Firestore(new commonE4edcbc6_node.FirebaseAuthCredentialsProvider(container.getProvider('auth-internal')), new commonE4edcbc6_node.FirebaseAppCheckTokenProvider(app, container.getProvider('app-check-internal')), commonE4edcbc6_node.databaseIdFromApp(app, databaseId), app);
...
class AggregateQuerySnapshot {
    ...
    _fieldsProto() {
        ...
        const dataClone = new commonE4edcbc6_node.ObjectValue({
...
class DocumentSnapshot$1 {
     ...
     */
    get ref() {
        return new commonE4edcbc6_node.DocumentReference(this._firestore, this._converter, this._key);
    }
    /**
    ...
    get(fieldPath) {
        if (this._document) {
            const value = this._document.data.field(commonE4edcbc6_node.fieldPathFromArgument('DocumentSnapshot.get', fieldPath));
            if (value !== null) {
...
function validateHasExplicitOrderByForLimitToLast(query) {
    if (query.limitType === "L" /* LimitType.Last */ &&
        ...
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.UNIMPLEMENTED, 'limitToLast() queries require specifying at least one orderBy() clause');
    }
}
/**
...
class QueryFieldFilterConstraint extends QueryConstraint {
    ...
    _apply(query) {
        ...
        return new commonE4edcbc6_node.Query(query.firestore, query.converter, commonE4edcbc6_node.queryWithAddedFilter(query._query, filter));
    }
    _parse(query) {
        const reader = commonE4edcbc6_node.newUserDataReader(query.firestore);
...
function where(fieldPath, opStr, value) {
    const op = opStr;
    const field = commonE4edcbc6_node.fieldPathFromArgument('where', fieldPath);
...
class QueryCompositeFilterConstraint extends AppliableConstraint {
    ...
    _parse(query) {
        ...
        return commonE4edcbc6_node.CompositeFilter.create(parsedFilters, this._getOperator());
    }
    _apply(query) {
        ...
        return new commonE4edcbc6_node.Query(query.firestore, query.converter, commonE4edcbc6_node.queryWithAddedFilter(query._query, parsedFilter));
    }
...
class QueryOrderByConstraint extends QueryConstraint {
    ...
    _apply(query) {
        ...
        return new commonE4edcbc6_node.Query(query.firestore, query.converter, commonE4edcbc6_node.queryWithAddedOrderBy(query._query, orderBy));
    }
}
/**
...
function orderBy(fieldPath, directionStr = 'asc') {
    ...
    const path = commonE4edcbc6_node.fieldPathFromArgument('orderBy', fieldPath);
...
class QueryLimitConstraint extends QueryConstraint {
    ...
    _apply(query) {
        return new commonE4edcbc6_node.Query(query.firestore, query.converter, commonE4edcbc6_node.queryWithLimit(query._query, this._limit, this._limitType));
    }
}
/**
...
function limit(limit) {
    commonE4edcbc6_node.validatePositiveNumber('limit', limit);
...
function limitToLast(limit) {
    commonE4edcbc6_node.validatePositiveNumber('limitToLast', limit);
...
class QueryStartAtConstraint extends QueryConstraint {
    ...
    _apply(query) {
        ...
        return new commonE4edcbc6_node.Query(query.firestore, query.converter, commonE4edcbc6_node.queryWithStartAt(query._query, bound));
    }
}
...
class QueryEndAtConstraint extends QueryConstraint {
    ...
    _apply(query) {
        const bound = newQueryBoundFromDocOrFields(query, this.type, this._docOrFields, this._inclusive);
        return new commonE4edcbc6_node.Query(query.firestore, query.converter, commonE4edcbc6_node.queryWithEndAt(query._query, bound));
    }
}
...
function newQueryFilter(query, methodName, dataReader, databaseId, fieldPath, op, value) {
    ...
    if (fieldPath.isKeyField()) {
        if (op === "array-contains" /* Operator.ARRAY_CONTAINS */ || op === "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */) {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, `Invalid Query. You can't perform '${op}' queries on documentId().`);
        }
        ...
        fieldValue = commonE4edcbc6_node.parseQueryValue(dataReader, methodName, value, 
        /* allowArrays= */ op === "in" /* Operator.IN */ || op === "not-in" /* Operator.NOT_IN */);
    }
    const filter = commonE4edcbc6_node.FieldFilter.create(fieldPath, op, fieldValue);
    return filter;
}
function newQueryOrderBy(query, fieldPath, direction) {
    if (query.startAt !== null) {
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'Invalid query. You must not call startAt() or startAfter() before ' +
            'calling orderBy().');
    }
    if (query.endAt !== null) {
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'Invalid query. You must not call endAt() or endBefore() before ' +
            'calling orderBy().');
    }
    const orderBy = new commonE4edcbc6_node.OrderBy(fieldPath, direction);
    return orderBy;
}
/**
...
function newQueryBoundFromDocument(query, databaseId, methodName, doc, inclusive) {
    if (!doc) {
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ` +
            `${methodName}().`);
    }
    const components = [];
    ...
    // results.
    for (const orderBy of commonE4edcbc6_node.queryNormalizedOrderBy(query)) {
        if (orderBy.field.isKeyField()) {
            components.push(commonE4edcbc6_node.refValue(databaseId, doc.key));
        }
        else {
            const value = doc.data.field(orderBy.field);
            if (commonE4edcbc6_node.isServerTimestamp(value)) {
                throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a ' +
    ...
    return new commonE4edcbc6_node.Bound(components, inclusive);
}
/**
...
function newQueryBoundFromFields(query, databaseId, dataReader, methodName, values, inclusive) {
    ...
    if (values.length > orderBy.length) {
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, `Too many arguments provided to ${methodName}(). ` +
    ...
    for (let i = 0; i < values.length; i++) {
        ...
        if (orderByComponent.field.isKeyField()) {
            if (typeof rawValue !== 'string') {
                throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ` +
                    `${methodName}(), but got a ${typeof rawValue}`);
            }
            if (!commonE4edcbc6_node.isCollectionGroupQuery(query) && rawValue.indexOf('/') !== -1) {
                throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), ` +
                    `the value passed to ${methodName}() must be a plain document ID, but ` +
                    `'${rawValue}' contains a slash.`);
            }
            const path = query.path.child(commonE4edcbc6_node.ResourcePath.fromString(rawValue));
            if (!commonE4edcbc6_node.DocumentKey.isDocumentKey(path)) {
                throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by ` +
                    `documentId(), the value passed to ${methodName}() must result in a ` +
                    `valid document path, but '${path}' is not because it contains an odd number ` +
                    `of segments.`);
            }
            const key = new commonE4edcbc6_node.DocumentKey(path);
            components.push(commonE4edcbc6_node.refValue(databaseId, key));
        }
        else {
            const wrapped = commonE4edcbc6_node.parseQueryValue(dataReader, methodName, rawValue);
...
function parseDocumentIdValue(databaseId, query, documentIdValue) {
    ...
    if (typeof documentIdValue === 'string') {
        if (documentIdValue === '') {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'Invalid query. When querying with documentId(), you ' +
                'must provide a valid document ID, but it was an empty string.');
        }
        if (!commonE4edcbc6_node.isCollectionGroupQuery(query) && documentIdValue.indexOf('/') !== -1) {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, `Invalid query. When querying a collection by ` +
                `documentId(), you must provide a plain document ID, but ` +
                `'${documentIdValue}' contains a '/' character.`);
        }
        const path = query.path.child(commonE4edcbc6_node.ResourcePath.fromString(documentIdValue));
        if (!commonE4edcbc6_node.DocumentKey.isDocumentKey(path)) {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, `Invalid query. When querying a collection group by ` +
                `documentId(), the value provided must result in a valid document path, ` +
                `but '${path}' is not because it has an odd number of segments (${path.length}).`);
        }
        return commonE4edcbc6_node.refValue(databaseId, new commonE4edcbc6_node.DocumentKey(path));
    }
    else if (documentIdValue instanceof commonE4edcbc6_node.DocumentReference) {
        return commonE4edcbc6_node.refValue(databaseId, documentIdValue._key);
    }
    else {
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, `Invalid query. When querying with documentId(), you must provide a valid ` +
            `string or a DocumentReference, but it was: ` +
            `${commonE4edcbc6_node.valueDescription(documentIdValue)}.`);
    }
}
/**
...
function validateDisjunctiveFilterElements(value, operator) {
    if (!Array.isArray(value) || value.length === 0) {
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'Invalid Query. A non-empty array is required for ' +
...
function validateNewFieldFilter(query, fieldFilter) {
    ...
    if (conflictingOp !== null) {
        ...
        if (conflictingOp === fieldFilter.op) {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'Invalid query. You cannot use more than one ' +
                `'${fieldFilter.op.toString()}' filter.`);
        }
        else {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, `Invalid query. You cannot use '${fieldFilter.op.toString()}' filters ` +
...
function validateNewFilter(query, filter) {
    ...
    for (const subFilter of subFilters) {
        ...
        testQuery = commonE4edcbc6_node.queryWithAddedFilter(testQuery, subFilter);
    }
}
...
function validateQueryFilterConstraint(functionName, queryConstraint) {
    if (!(queryConstraint instanceof QueryFieldFilterConstraint) &&
        ...
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, `Function ${functionName}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
    }
}
function validateQueryConstraintArray(queryConstraint) {
    ...
    if (compositeFilterCount > 1 ||
        ...
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'InvalidQuery. When using composite filters, you cannot use ' +
...
class LiteUserDataWriter extends commonE4edcbc6_node.AbstractUserDataWriter {
    constructor(firestore) {
        super();
        this.firestore = firestore;
    }
    convertBytes(bytes) {
        return new commonE4edcbc6_node.Bytes(bytes);
    }
    convertReference(name) {
        const key = this.convertDocumentKey(name, this.firestore._databaseId);
        return new commonE4edcbc6_node.DocumentReference(this.firestore, /* converter= */ null, key);
    }
}
 ...
 */
function sum(field) {
    return new AggregateField('sum', commonE4edcbc6_node.fieldPathFromArgument('sum', field));
}
/**
...
function average(field) {
    return new AggregateField('avg', commonE4edcbc6_node.fieldPathFromArgument('average', field));
}
/**
...
function aggregateQuerySnapshotEqual(left, right) {
    return (commonE4edcbc6_node.queryEqual(left.query, right.query) && util.deepEqual(left.data(), right.data()));
}
...
function getAggregateFromServer(query, aggregateSpec) {
    const firestore = commonE4edcbc6_node.cast(query.firestore, commonE4edcbc6_node.Firestore);
    const client = commonE4edcbc6_node.ensureFirestoreConfigured(firestore);
    const internalAggregates = commonE4edcbc6_node.mapToArray(aggregateSpec, (aggregate, alias) => {
        return new commonE4edcbc6_node.AggregateImpl(alias, aggregate.aggregateType, aggregate._internalFieldPath);
    });
    // Run the aggregation and convert the results
    return commonE4edcbc6_node.firestoreClientRunAggregateQuery(client, query._query, internalAggregates).then(aggregateResult => convertToAggregateQuerySnapshot(firestore, query, aggregateResult));
}
/**
...
class MemoryLocalCacheImpl {
    constructor(settings) {
        this.kind = 'memory';
        this._onlineComponentProvider = commonE4edcbc6_node.OnlineComponentProvider.provider;
        if (settings?.garbageCollector) {
            ...
            this._offlineComponentProvider = {
                build: () => new commonE4edcbc6_node.LruGcMemoryOfflineComponentProvider(undefined)
            };
        }
    }
    toJSON() {
...
class MemoryEagerGarbageCollectorImpl {
    constructor() {
        ...
        this._offlineComponentProvider = commonE4edcbc6_node.MemoryOfflineComponentProvider.provider;
    }
    toJSON() {
        return { kind: this.kind };
    }
...
class MemoryLruGarbageCollectorImpl {
    constructor(cacheSize) {
        this.kind = 'memoryLru';
        this._offlineComponentProvider = {
            build: () => new commonE4edcbc6_node.LruGcMemoryOfflineComponentProvider(cacheSize)
        };
    }
    toJSON() {
        return { kind: this.kind };
...
class SingleTabManagerImpl {
    ...
    _initialize(settings) {
        this._onlineComponentProvider = commonE4edcbc6_node.OnlineComponentProvider.provider;
        this._offlineComponentProvider = {
            build: (onlineComponents) => new commonE4edcbc6_node.IndexedDbOfflineComponentProvider(onlineComponents, settings?.cacheSizeBytes, this.forceOwnership)
        };
    }
}
class MultiTabManagerImpl {
    ...
    _initialize(settings) {
        this._onlineComponentProvider = commonE4edcbc6_node.OnlineComponentProvider.provider;
        this._offlineComponentProvider = {
            build: (onlineComponents) => new commonE4edcbc6_node.MultiTabOfflineComponentProvider(onlineComponents, settings?.cacheSizeBytes)
        };
    }
}
/**
...
const encoder = commonE4edcbc6_node.newTextEncoder();
...
class BundleBuilder {
    constructor(firestore, bundleId) {
        ...
        this.latestReadTime = new commonE4edcbc6_node.Timestamp(0, 0);
        ...
        this.serializer = new commonE4edcbc6_node.JsonProtoSerializer(this.databaseId, 
        /*useProto3Json=*/ true);
        this.userDataReader = new commonE4edcbc6_node.UserDataReader(this.databaseId, true, this.serializer);
    }
    /**
    ...
    addBundleDocument(docBundleData, queryName) {
        ...
        const origDocReadTime = !!originalDocument?.metadata
            .readTime
            ? commonE4edcbc6_node.fromTimestamp(originalDocument.metadata.readTime)
            : null;
        ...
        if (neitherHasReadTime || docIsNewer) {
            ...
            this.documents.set(docBundleData.documentPath, {
                ...
                metadata: {
                    name: commonE4edcbc6_node.toName(this.serializer, docBundleData.documentKey),
                    readTime: !!docReadTime
                        ? commonE4edcbc6_node.toTimestamp(this.serializer, docReadTime) // Convert Timestamp to proto format.
                        : undefined,
    ...
    addBundleQuery(queryBundleData) {
        ...
        let latestReadTime = new commonE4edcbc6_node.Timestamp(0, 0);
        ...
        const queryTarget = commonE4edcbc6_node.toQueryTarget(this.serializer, commonE4edcbc6_node.queryToTarget(queryBundleData.query));
        const bundledQuery = {
        ...
        this.namedQueries.set(queryBundleData.name, {
            ...
            bundledQuery,
            readTime: commonE4edcbc6_node.toTimestamp(this.serializer, latestReadTime)
        });
    }
    /**
    ...
    toBundleDocument(docBundleData) {
        ...
        const proto3Fields = commonE4edcbc6_node.parseObject(docBundleData.documentData, context);
        return {
            name: commonE4edcbc6_node.toName(this.serializer, docBundleData.documentKey),
            fields: proto3Fields.mapValue.fields,
            updateTime: commonE4edcbc6_node.toTimestamp(this.serializer, docBundleData.versionTime),
            createTime: commonE4edcbc6_node.toTimestamp(this.serializer, docBundleData.createdTime)
        };
    }
    /**
    ...
    build() {
        ...
        const metadata = {
            id: this.bundleId,
            createTime: commonE4edcbc6_node.toTimestamp(this.serializer, this.latestReadTime),
...
function buildDocumentSnapshotJsonBundle(db, document, docData, path) {
    const builder = new BundleBuilder(db, commonE4edcbc6_node.AutoId.newId());
...
class DocumentSnapshot extends DocumentSnapshot$1 {
    ...
    toJSON() {
        if (this.metadata.hasPendingWrites) {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.FAILED_PRECONDITION, 'DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. ' +
...
DocumentSnapshot._jsonSchema = {
    type: commonE4edcbc6_node.property('string', DocumentSnapshot._jsonSchemaVersion),
    bundleSource: commonE4edcbc6_node.property('string', 'DocumentSnapshot'),
    bundleName: commonE4edcbc6_node.property('string'),
    bundle: commonE4edcbc6_node.property('string')
};
function documentSnapshotFromJSON(db, json, converter) {
    if (commonE4edcbc6_node.validateJSON(json, DocumentSnapshot._jsonSchema)) {
        if (json.bundle === NOT_SUPPORTED) {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'The provided JSON object was created in a client environment, which is not supported.');
        }
        // Parse the bundle data.
        const serializer = commonE4edcbc6_node.newSerializer(db._databaseId);
        const bundleReader = commonE4edcbc6_node.createBundleReaderSync(json.bundle, serializer);
        const elements = bundleReader.getElements();
        const bundleLoader = new commonE4edcbc6_node.BundleLoader(bundleReader.getMetadata(), serializer);
        ...
        if (bundledDocuments.length !== 1) {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, `Expected bundle data to contain 1 document, but it contains ${bundledDocuments.length} documents.`);
        }
        // Build out the internal document data.
        const document = commonE4edcbc6_node.fromDocument(serializer, bundledDocuments[0].document);
        const documentKey = new commonE4edcbc6_node.DocumentKey(commonE4edcbc6_node.ResourcePath.fromString(json.bundleName));
...
class QuerySnapshot {
    ...
    docChanges(options = {}) {
        ...
        if (includeMetadataChanges && this._snapshot.excludesMetadataChanges) {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'To include metadata changes with your document changes, you must ' +
    ...
    toJSON() {
        if (this.metadata.hasPendingWrites) {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.FAILED_PRECONDITION, 'QuerySnapshot.toJSON() attempted to serialize a document with pending writes. ' +
                'Await waitForPendingWrites() before invoking toJSON().');
        }
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const result = {};
        ...
        result['bundleName'] = commonE4edcbc6_node.AutoId.newId();
...
QuerySnapshot._jsonSchema = {
    type: commonE4edcbc6_node.property('string', QuerySnapshot._jsonSchemaVersion),
    bundleSource: commonE4edcbc6_node.property('string', 'QuerySnapshot'),
    bundleName: commonE4edcbc6_node.property('string'),
    bundle: commonE4edcbc6_node.property('string')
};
function querySnapshotFromJSON(db, json, converter) {
    if (commonE4edcbc6_node.validateJSON(json, QuerySnapshot._jsonSchema)) {
        if (json.bundle === NOT_SUPPORTED) {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'The provided JSON object was created in a client environment, which is not supported.');
        }
        // Parse the bundle data.
        ...
        if (bundleLoader.queries.length !== 1) {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, `Snapshot data expected 1 query but found ${bundleLoader.queries.length} queries.`);
        }
        // Create an internal Query object from the named query in the bundle.
        const query = commonE4edcbc6_node.fromBundledQuery(bundleLoader.queries[0].bundledQuery);
        // Construct the arrays of document data for the query.
        const bundledDocuments = bundleLoader.documents;
        let documentSet = new commonE4edcbc6_node.DocumentSet();
        bundledDocuments.map(bundledDocument => {
            const document = commonE4edcbc6_node.fromDocument(serializer, bundledDocument.document);
            documentSet = documentSet.add(document);
        });
        // Create a view snapshot of the query and documents.
        const viewSnapshot = commonE4edcbc6_node.ViewSnapshot.fromInitialDocuments(query, documentSet, commonE4edcbc6_node.documentKeySet() /* Zero mutated keys signifies no pending writes. */, 
        /* fromCache= */ false, 
        /* hasCachedResults= */ false);
        // Create an external Query object, required to construct the QuerySnapshot.
        const externalQuery = new commonE4edcbc6_node.Query(db, converter ? converter : null, query);
...
function resultChangeType(type) {
    switch (type) {
        ...
        case 1 /* ChangeType.Removed */:
            return 'removed';
        default:
            return commonE4edcbc6_node.fail(0xf03d, { type });
    }
}
...
function snapshotEqual(left, right) {
    if (left instanceof DocumentSnapshot && right instanceof DocumentSnapshot) {
        ...
        return (left._firestore === right._firestore &&
            commonE4edcbc6_node.queryEqual(left.query, right.query) &&
...
function validateTransactionOptions(options) {
    if (options.maxAttempts < 1) {
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'Max attempts must be at least 1');
    }
}
...
class WriteBatch {
    ...
    constructor(_firestore, _commitHandler) {
        ...
        this._dataReader = commonE4edcbc6_node.newUserDataReader(_firestore);
    }
    set(documentRef, data, options) {
        this._verifyNotCommitted();
        const ref = validateReference(documentRef, this._firestore);
        const convertedValue = applyFirestoreDataConverter(ref.converter, data, options);
        const parsed = commonE4edcbc6_node.parseSetData(this._dataReader, 'WriteBatch.set', ref._key, convertedValue, ref.converter !== null, options);
        this._mutations.push(parsed.toMutation(ref._key, commonE4edcbc6_node.Precondition.none()));
        return this;
    }
    update(documentRef, fieldOrUpdateData, value, ...moreFieldsAndValues) {
        ...
        if (typeof fieldOrUpdateData === 'string' ||
            fieldOrUpdateData instanceof commonE4edcbc6_node.FieldPath) {
            parsed = commonE4edcbc6_node.parseUpdateVarargs(this._dataReader, 'WriteBatch.update', ref._key, fieldOrUpdateData, value, moreFieldsAndValues);
        }
        else {
            parsed = commonE4edcbc6_node.parseUpdateData(this._dataReader, 'WriteBatch.update', ref._key, fieldOrUpdateData);
        }
        this._mutations.push(parsed.toMutation(ref._key, commonE4edcbc6_node.Precondition.exists(true)));
        return this;
    }
    /**
    ...
    delete(documentRef) {
        this._verifyNotCommitted();
        const ref = validateReference(documentRef, this._firestore);
        this._mutations = this._mutations.concat(new commonE4edcbc6_node.DeleteMutation(ref._key, commonE4edcbc6_node.Precondition.none()));
        return this;
    }
    /**
    ...
    _verifyNotCommitted() {
        if (this._committed) {
            throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.FAILED_PRECONDITION, 'A write batch can no longer be used after commit() ' +
                'has been called.');
        }
    }
}
function validateReference(documentRef, firestore) {
    ...
    if (documentRef.firestore !== firestore) {
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'Provided document reference is from a different Firestore instance.');
    }
    else {
        return documentRef;
    }
...
class Transaction$1 {
    ...
    get(documentRef) {
        ...
        return this._transaction.lookup([ref._key]).then(docs => {
            if (!docs || docs.length !== 1) {
                return commonE4edcbc6_node.fail(0x5de9);
            }
            const doc = docs[0];
            if (doc.isFoundDocument()) {
                ...
                throw commonE4edcbc6_node.fail(0x4801, {
                    doc
                });
            }
        });
    ...
    set(documentRef, value, options) {
        ...
        const parsed = commonE4edcbc6_node.parseSetData(this._dataReader, 'Transaction.set', ref._key, convertedValue, ref.converter !== null, options);
    ...
    update(documentRef, fieldOrUpdateData, value, ...moreFieldsAndValues) {
        ...
        if (typeof fieldOrUpdateData === 'string' ||
            fieldOrUpdateData instanceof commonE4edcbc6_node.FieldPath) {
            parsed = commonE4edcbc6_node.parseUpdateVarargs(this._dataReader, 'Transaction.update', ref._key, fieldOrUpdateData, value, moreFieldsAndValues);
        }
        else {
            parsed = commonE4edcbc6_node.parseUpdateData(this._dataReader, 'Transaction.update', ref._key, fieldOrUpdateData);
        }
...
class Transaction extends Transaction$1 {
    ...
    get(documentRef) {
        const ref = validateReference(documentRef, this._firestore);
        const userDataWriter = new commonE4edcbc6_node.ExpUserDataWriter(this._firestore);
        return super
            .get(documentRef)
...
function runTransaction(firestore, updateFunction, options) {
    firestore = commonE4edcbc6_node.cast(firestore, commonE4edcbc6_node.Firestore);
    ...
    const client = commonE4edcbc6_node.ensureFirestoreConfigured(firestore);
    return commonE4edcbc6_node.firestoreClientTransaction(client, internalTransaction => updateFunction(new Transaction(firestore, internalTransaction)), optionsWithDefaults);
}
...
function getDoc(reference) {
    reference = commonE4edcbc6_node.cast(reference, commonE4edcbc6_node.DocumentReference);
    const firestore = commonE4edcbc6_node.cast(reference.firestore, commonE4edcbc6_node.Firestore);
    const client = commonE4edcbc6_node.ensureFirestoreConfigured(firestore);
    return commonE4edcbc6_node.firestoreClientGetDocumentViaSnapshotListener(client, reference._key).then(snapshot => convertToDocSnapshot(firestore, reference, snapshot));
}
/**
...
function getDocFromCache(reference) {
    ...
    const client = commonE4edcbc6_node.ensureFirestoreConfigured(firestore);
    const userDataWriter = new commonE4edcbc6_node.ExpUserDataWriter(firestore);
    return commonE4edcbc6_node.firestoreClientGetDocumentFromLocalCache(client, reference._key).then(doc => new DocumentSnapshot(firestore, userDataWriter, reference._key, doc, new SnapshotMetadata(doc !== null && doc.hasLocalMutations, 
...
function getDocFromServer(reference) {
    ...
    const firestore = commonE4edcbc6_node.cast(reference.firestore, commonE4edcbc6_node.Firestore);
    const client = commonE4edcbc6_node.ensureFirestoreConfigured(firestore);
    return commonE4edcbc6_node.firestoreClientGetDocumentViaSnapshotListener(client, reference._key, {
        source: 'server'
...
function getDocs(query) {
    query = commonE4edcbc6_node.cast(query, commonE4edcbc6_node.Query);
    const firestore = commonE4edcbc6_node.cast(query.firestore, commonE4edcbc6_node.Firestore);
    const client = commonE4edcbc6_node.ensureFirestoreConfigured(firestore);
    const userDataWriter = new commonE4edcbc6_node.ExpUserDataWriter(firestore);
    validateHasExplicitOrderByForLimitToLast(query._query);
    return commonE4edcbc6_node.firestoreClientGetDocumentsViaSnapshotListener(client, query._query).then(snapshot => new QuerySnapshot(firestore, userDataWriter, query, snapshot));
}
/**
...
function getDocsFromCache(query) {
    ...
    const client = commonE4edcbc6_node.ensureFirestoreConfigured(firestore);
    const userDataWriter = new commonE4edcbc6_node.ExpUserDataWriter(firestore);
    return commonE4edcbc6_node.firestoreClientGetDocumentsFromLocalCache(client, query._query).then(snapshot => new QuerySnapshot(firestore, userDataWriter, query, snapshot));
}
/**
...
function getDocsFromServer(query) {
    ...
    const client = commonE4edcbc6_node.ensureFirestoreConfigured(firestore);
    const userDataWriter = new commonE4edcbc6_node.ExpUserDataWriter(firestore);
    return commonE4edcbc6_node.firestoreClientGetDocumentsViaSnapshotListener(client, query._query, {
        source: 'server'
...
function setDoc(reference, data, options) {
    ...
    const dataReader = commonE4edcbc6_node.newUserDataReader(firestore);
    const parsed = commonE4edcbc6_node.parseSetData(dataReader, 'setDoc', reference._key, convertedValue, reference.converter !== null, options);
    const mutation = parsed.toMutation(reference._key, commonE4edcbc6_node.Precondition.none());
...
function updateDoc(reference, fieldOrUpdateData, value, ...moreFieldsAndValues) {
    ...
    if (typeof fieldOrUpdateData === 'string' ||
        fieldOrUpdateData instanceof commonE4edcbc6_node.FieldPath) {
        parsed = commonE4edcbc6_node.parseUpdateVarargs(dataReader, 'updateDoc', reference._key, fieldOrUpdateData, value, moreFieldsAndValues);
    }
    else {
        parsed = commonE4edcbc6_node.parseUpdateData(dataReader, 'updateDoc', reference._key, fieldOrUpdateData);
    }
    const mutation = parsed.toMutation(reference._key, commonE4edcbc6_node.Precondition.exists(true));
    return executeWrite(firestore, [mutation]);
}
/**
...
function deleteDoc(reference) {
    const firestore = commonE4edcbc6_node.cast(reference.firestore, commonE4edcbc6_node.Firestore);
    const mutations = [new commonE4edcbc6_node.DeleteMutation(reference._key, commonE4edcbc6_node.Precondition.none())];
...
function addDoc(reference, data) {
    const firestore = commonE4edcbc6_node.cast(reference.firestore, commonE4edcbc6_node.Firestore);
    const docRef = commonE4edcbc6_node.doc(reference);
    const convertedValue = applyFirestoreDataConverter(reference.converter, data);
    const dataReader = commonE4edcbc6_node.newUserDataReader(reference.firestore);
    const parsed = commonE4edcbc6_node.parseSetData(dataReader, 'addDoc', docRef._key, convertedValue, reference.converter !== null, {});
    const mutation = parsed.toMutation(docRef._key, commonE4edcbc6_node.Precondition.exists(false));
...
function onSnapshot(reference, ...args) {
    ...
    let firestore;
    let internalQuery;
    if (reference instanceof commonE4edcbc6_node.DocumentReference) {
        firestore = commonE4edcbc6_node.cast(reference.firestore, commonE4edcbc6_node.Firestore);
        internalQuery = commonE4edcbc6_node.newQueryForPath(reference._key.path);
        observer = {
            next: snapshot => {
                if (args[currArg]) {
        ...
        const query = commonE4edcbc6_node.cast(reference, commonE4edcbc6_node.Query);
        firestore = commonE4edcbc6_node.cast(query.firestore, commonE4edcbc6_node.Firestore);
    ...
    const client = commonE4edcbc6_node.ensureFirestoreConfigured(firestore);
    return commonE4edcbc6_node.firestoreClientListen(client, internalQuery, internalOptions, observer);
}
function onSnapshotResume(reference, snapshotJson, ...args) {
    ...
    if (json.error) {
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, json.error);
    }
    let curArg = 0;
    ...
    if (json.bundleSource === 'QuerySnapshot') {
        ...
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, `unsupported bundle source: ${json.bundleSource}`);
    }
}
function onSnapshotsInSync(firestore, arg) {
    ...
    return commonE4edcbc6_node.firestoreClientAddSnapshotsInSyncListener(client, observer);
}
/**
...
function executeWrite(firestore, mutations) {
    const client = commonE4edcbc6_node.ensureFirestoreConfigured(firestore);
    return commonE4edcbc6_node.firestoreClientWrite(client, mutations);
}
/**
...
function onSnapshotDocumentSnapshotBundle(db, json, options, observer, converter) {
    ...
    const loadTask = commonE4edcbc6_node.loadBundle(db, json.bundle);
    loadTask
        .then(() => {
        if (!unsubscribed) {
            const docReference = new commonE4edcbc6_node.DocumentReference(db, converter ? converter : null, commonE4edcbc6_node.DocumentKey.fromPath(json.bundleName));
...
function onSnapshotQuerySnapshotBundle(db, json, options, observer, converter) {
    ...
    const loadTask = commonE4edcbc6_node.loadBundle(db, json.bundle);
    loadTask
        .then(() => commonE4edcbc6_node.namedQuery(db, json.bundleName))
        .then(query => {
...
function writeBatch(firestore) {
    firestore = commonE4edcbc6_node.cast(firestore, commonE4edcbc6_node.Firestore);
    commonE4edcbc6_node.ensureFirestoreConfigured(firestore);
...
function setIndexConfiguration(firestore, jsonOrConfiguration) {
    ...
    if (!client._uninitializedComponentsProvider ||
        ...
        commonE4edcbc6_node.logWarn('Cannot enable indexes when persistence is disabled');
        return Promise.resolve();
    }
    const parsedIndexes = parseIndexes(jsonOrConfiguration);
    return commonE4edcbc6_node.firestoreClientSetIndexConfiguration(client, parsedIndexes);
}
        ...
        for (const index of indexConfiguration.indexes) {
            ...
            if (Array.isArray(index.fields)) {
                for (const field of index.fields) {
                    ...
                    const fieldPath = commonE4edcbc6_node.fieldPathFromDotSeparatedString('setIndexConfiguration', fieldPathString);
                    if (field.arrayConfig === 'CONTAINS') {
                        segments.push(new commonE4edcbc6_node.IndexSegment(fieldPath, 2 /* IndexKind.CONTAINS */));
                    }
                    else if (field.order === 'ASCENDING') {
                        segments.push(new commonE4edcbc6_node.IndexSegment(fieldPath, 0 /* IndexKind.ASCENDING */));
                    }
                    else if (field.order === 'DESCENDING') {
                        segments.push(new commonE4edcbc6_node.IndexSegment(fieldPath, 1 /* IndexKind.DESCENDING */));
                    }
                }
            }
            parsedIndexes.push(new commonE4edcbc6_node.FieldIndex(commonE4edcbc6_node.FieldIndex.UNKNOWN_ID, collectionGroup, segments, commonE4edcbc6_node.IndexState.empty()));
        }
    }
...
function tryParseJson(json) {
    try {
        ...
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'Failed to parse JSON: ' + e?.message);
    }
}
function tryGetString(data, property) {
    if (typeof data[property] !== 'string') {
        throw new commonE4edcbc6_node.FirestoreError(commonE4edcbc6_node.Code.INVALID_ARGUMENT, 'Missing string value for: ' + property);
    }
...
function deleteAllPersistentCacheIndexes(indexManager) {
    const client = commonE4edcbc6_node.ensureFirestoreConfigured(indexManager._firestore);
    const promise = commonE4edcbc6_node.firestoreClientDeleteAllFieldIndexes(client);
    promise
        .then(_ => commonE4edcbc6_node.logDebug('deleting all persistent cache indexes succeeded'))
        .catch(error => commonE4edcbc6_node.logWarn('deleting all persistent cache indexes failed', error));
}
function setPersistentCacheIndexAutoCreationEnabled(indexManager, isEnabled) {
    const client = commonE4edcbc6_node.ensureFirestoreConfigured(indexManager._firestore);
    const promise = commonE4edcbc6_node.firestoreClientSetPersistentCacheIndexAutoCreationEnabled(client, isEnabled);
    promise
        .then(_ => commonE4edcbc6_node.logDebug(`setting persistent cache index auto creation ` +
        `isEnabled=${isEnabled} succeeded`))
        .catch(error => commonE4edcbc6_node.logWarn(`setting persistent cache index auto creation ` +
...
class TestingHooksSpiImpl {
    ...
    static get instance() {
        if (!testingHooksSpiImplInstance) {
            ...
            commonE4edcbc6_node.setTestingHooksSpi(testingHooksSpiImplInstance);
        }
...
exports.AbstractUserDataWriter = commonE4edcbc6_node.AbstractUserDataWriter;
exports.Bytes = commonE4edcbc6_node.Bytes;
exports.CACHE_SIZE_UNLIMITED = commonE4edcbc6_node.CACHE_SIZE_UNLIMITED;
exports.CollectionReference = commonE4edcbc6_node.CollectionReference;
exports.DocumentReference = commonE4edcbc6_node.DocumentReference;
exports.FieldPath = commonE4edcbc6_node.FieldPath;
exports.FieldValue = commonE4edcbc6_node.FieldValue;
exports.Firestore = commonE4edcbc6_node.Firestore;
exports.FirestoreError = commonE4edcbc6_node.FirestoreError;
exports.GeoPoint = commonE4edcbc6_node.GeoPoint;
exports.LoadBundleTask = commonE4edcbc6_node.LoadBundleTask;
exports.Query = commonE4edcbc6_node.Query;
exports.Timestamp = commonE4edcbc6_node.Timestamp;
exports.VectorValue = commonE4edcbc6_node.VectorValue;
exports._AutoId = commonE4edcbc6_node.AutoId;
exports._ByteString = commonE4edcbc6_node.ByteString;
exports._DatabaseId = commonE4edcbc6_node.DatabaseId;
exports._DocumentKey = commonE4edcbc6_node.DocumentKey;
exports._EmptyAppCheckTokenProvider = commonE4edcbc6_node.EmptyAppCheckTokenProvider;
exports._EmptyAuthCredentialsProvider = commonE4edcbc6_node.EmptyAuthCredentialsProvider;
exports._FieldPath = commonE4edcbc6_node.FieldPath$1;
exports._cast = commonE4edcbc6_node.cast;
exports._debugAssert = commonE4edcbc6_node.debugAssert;
exports._internalAggregationQueryToProtoRunAggregationQueryRequest = commonE4edcbc6_node._internalAggregationQueryToProtoRunAggregationQueryRequest;
exports._internalQueryToProtoQueryTarget = commonE4edcbc6_node._internalQueryToProtoQueryTarget;
exports._isBase64Available = commonE4edcbc6_node.isBase64Available;
exports._logWarn = commonE4edcbc6_node.logWarn;
exports._validateIsNotUsedTogether = commonE4edcbc6_node.validateIsNotUsedTogether;
exports.arrayRemove = commonE4edcbc6_node.arrayRemove;
exports.arrayUnion = commonE4edcbc6_node.arrayUnion;
exports.clearIndexedDbPersistence = commonE4edcbc6_node.clearIndexedDbPersistence;
exports.collection = commonE4edcbc6_node.collection;
exports.collectionGroup = commonE4edcbc6_node.collectionGroup;
exports.connectFirestoreEmulator = commonE4edcbc6_node.connectFirestoreEmulator;
exports.deleteField = commonE4edcbc6_node.deleteField;
exports.disableNetwork = commonE4edcbc6_node.disableNetwork;
exports.doc = commonE4edcbc6_node.doc;
exports.documentId = commonE4edcbc6_node.documentId;
exports.enableIndexedDbPersistence = commonE4edcbc6_node.enableIndexedDbPersistence;
exports.enableMultiTabIndexedDbPersistence = commonE4edcbc6_node.enableMultiTabIndexedDbPersistence;
exports.enableNetwork = commonE4edcbc6_node.enableNetwork;
exports.ensureFirestoreConfigured = commonE4edcbc6_node.ensureFirestoreConfigured;
exports.getFirestore = commonE4edcbc6_node.getFirestore;
exports.increment = commonE4edcbc6_node.increment;
exports.initializeFirestore = commonE4edcbc6_node.initializeFirestore;
exports.loadBundle = commonE4edcbc6_node.loadBundle;
exports.namedQuery = commonE4edcbc6_node.namedQuery;
exports.queryEqual = commonE4edcbc6_node.queryEqual;
exports.refEqual = commonE4edcbc6_node.refEqual;
exports.serverTimestamp = commonE4edcbc6_node.serverTimestamp;
exports.setLogLevel = commonE4edcbc6_node.setLogLevel;
exports.terminate = commonE4edcbc6_node.terminate;
exports.vector = commonE4edcbc6_node.vector;
exports.waitForPendingWrites = commonE4edcbc6_node.waitForPendingWrites;
